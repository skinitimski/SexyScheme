...
namespace Atmosphere.SexyLib.Exceptions
{
    ...
    /// </summary>
    public class SexyParserException : SexySchemeException
    {
        /// <summary>
        ...
        public SexyParserException(string msg, params object[] parts) : base(String.Format(msg, parts))
        {
        }
        ...
        public SexyParserException(Exception inner, string msg) : base(msg, inner)
        {
        }
    }
}
